  ...
  return (
    <View style={[styles.safe, { backgroundColor: colors.background, paddingTop: top }]}>
      ...
      <View style={styles.statsGrid}>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.bestScoreCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <Text style={[styles.heroLabel, { color: colors.textMuted }]}>LAST RUN</Text>
            <Text style={[styles.heroValue, { color: colors.text, fontFamily: 'Rubik_700Bold' }]} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.5}>
              {lastRunScore > 0 ? lastRunScore.toLocaleString() : '—'}
            </Text>
          </View>
          <View style={[styles.bestScoreCard, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
            <Text style={[styles.heroLabel, { color: colors.textMuted }]}>DAY STREAK</Text>
            <Text style={[styles.heroValue, { color: colors.text, fontFamily: 'Rubik_700Bold' }]} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.5}>
...
const styles = StyleSheet.create({
  ...
  spacer:         { flex: 1, maxHeight: 56, justifyContent: 'center' },
  divider:        { height: 1 },
  ...
  bestScoreCard:  { flex: 1, borderRadius: 16, borderWidth: 1, alignItems: 'center', justifyContent: 'center', gap: 10 },
